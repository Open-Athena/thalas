...
def validate_thalas_gcp_path(path: str) -> str:
    """
    Validate the given path according to the thalas GCP convention.
    ...
    gs://thalas-$REGION/scratch//* (any structure after scratch)
    or
    gs://thalas-$REGION/(documents|attributes|filtered)/$EXPERIMENT/$DATASET/$VERSION/
    ...
    Example:
    >>> validate_thalas_gcp_path("gs://thalas-us-central1/documents/exp1/dataset1/v1/")
    'gs://thalas-us-central1/documents/exp1/dataset1/v1/'
    >>> validate_thalas_gcp_path("gs://thalas-us-central1/attributes/exp1/dataset1/v1/")
    'gs://thalas-us-central1/attributes/exp1/dataset1/v1/'
    >>> validate_thalas_gcp_path("gs://thalas-us-central1/filtered/exp1/dataset1/v1/")
    'gs://thalas-us-central1/filtered/exp1/dataset1/v1/'
    >>> validate_thalas_gcp_path("gs://thalas-us-central1/scratch/documents/exp1/dataset1/v1/")
    'gs://thalas-us-central1/scratch/documents/exp1/dataset1/v1/'
    >>> validate_thalas_gcp_path("gs://thalas-us-central1/scratch/decontamination/decontamination_demo.jsonl.gz")
    'gs://thalas-us-central1/scratch/decontamination/decontamination_demo.jsonl.gz'
    """
    pattern = r"^gs://thalas-[^/]+/(scratch/.+|(documents|attributes|filtered)/[^/]+/[^/]+/[^/]+(/.*)?$)"
    if not re.match(pattern, path):
        raise ValueError(
            "Invalid path format. It should follow either:\n"
            "1. gs://thalas-$REGION/scratch/* (any structure after scratch)\n"
            "2. gs://thalas-$REGION/{documents|attributes|filtered}/$EXPERIMENT/$DATASET/$VERSION/"
        )
    return path
